    ...
    <>
      ...
      <AppInfo>
        ...
        {account ? (
          ...
          <Button padding="0 10px !important" style={{ background: "#000", borderColor: "#FF0" }} onClick={handleConnect} active={account}>
            <Status active={account} />
            <Type.SM fontSize="20px" color="#FFCC00" cursor="pointer" fontSizeXS="13px">
              Connect Wallet2
            </Type.SM>
          </Button>
        )}
